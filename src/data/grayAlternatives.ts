...
export const STREAMING_SITES: GrayAlternative[] = [
  {
    name: "TVids.tv",
    url: "https://www.tvids.tv/",
    description: "Clean, ad-light streaming site for movies and TV shows. No signup needed, works in browser.",
    type: "streaming",
    logo: "📺",
  ...
  {
    name: "Fmovies",
    url: "https://fmoviesz.to",
    description: "One of the longest-running free streaming sites with a massive HD library of movies and TV.",
    type: "streaming",
    logo: "🎥",
    tags: ["movies", "tv", "HD"],
  },
  {
    ...
    description: "Large library of movies and series with multiple stream sources per title.",
    type: "streaming",
    logo: "☀️",
    tags: ["movies", "tv", "multiple sources"],
  },
  {
    name: "Bflix",
    url: "https://bflix.gg",
    description: "Fast, clean streaming site. Excellent for new movie releases and ongoing TV series.",
    type: "streaming",
    logo: "⚡",
    tags: ["movies", "tv", "fast"],
  },
  {
    ...
    description: "High-quality streams for movies and TV. Known for reliable uptime and clean interface.",
    type: "streaming",
    logo: "👁️",
    tags: ["movies", "tv", "high quality"],
  },
  {
    name: "Cataz.net",
    url: "https://cataz.net",
    description: "Aggregator pulling from multiple streaming sources. Subtitle support and clean UI.",
    type: "streaming",
    logo: "🐱",
    tags: ["movies", "tv", "subtitles", "aggregator"],
  },
  {
    name: "AniWatch / Aniwave",
    url: "https://aniwave.to",
    description: "The go-to for anime streaming — both subbed and dubbed. Massive library including seasonal airing shows.",
    type: "streaming",
    logo: "⛩️",
    tags: ["anime", "sub", "dub", "seasonal"],
  },
  {
    name: "9Anime",
    url: "https://9animetv.to",
    description: "Long-running anime streaming site with a huge back-catalogue and fast updates for airing shows.",
    type: "streaming",
    logo: "9️⃣",
    tags: ["anime", "sub", "dub"],
  },
  {
    ...
    description: "Legally free (ad-supported) streaming from Sony. Older movies and original content.",
    type: "streaming",
    logo: "💥",
    tags: ["movies", "tv", "legal", "ad-supported"],
